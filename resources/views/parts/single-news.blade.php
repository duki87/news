            ...
            <div class="s-right ml-100 ml-xs-85">
              ...
              @if(Auth::id() !== null)
                @if($comment->user !== null && $comment->user == Auth::id())
                  <a class="btn-brdr-grey btn-b-sm plr-15 mr-7" href="#"><b>Одговори</b></a>
                  <a class="btn-brdr-red btn-b-sm plr-15" href="#"><b>Обриши</b></a>
                @else
                  <a class="btn-brdr-grey btn-b-sm plr-15 mr-7 like-comment" data-comment_id="{{$comment->id}}" href="#"><b>Свиђа ми се</b></a>
                  <a class="btn-brdr-grey btn-b-sm plr-15" href="#"><b>Одговори</b></a>
                @endif
              @else
                <a class="btn-brdr-grey btn-b-sm plr-15 mr-7 like-comment" data-comment_id="{{$comment->id}}" href="#"><b>Свиђа ми се</b></a>
                <a class="btn-brdr-grey btn-b-sm plr-15 mr-7" href="#"><b>Одговори</b></a>
